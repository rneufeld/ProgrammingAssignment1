...
## First programming assignment for Coursera R Programming
...
You can see some example output from this function [link]. The function that you write should be able to match this output. Please save your code to a file named pollutantmean.R.
...
You can see some example output from this function [link]. The function that you write should be able to match this output. Please save your code to a file named complete.R. To run the submit script for this part, make sure your working directory has the file complete.R in it.
...
You can see some example output from this function [link]. The function that you write should be able to match this output. Please save your code to a file named corr.R. To run the submit script for this part, make sure your working directory has the file corr.R in it.
...
[link]
Or you can download the script to your working directory [link] (NOTE: you may need to rename the file to be "submitscript1.R". Then source the file locally via
